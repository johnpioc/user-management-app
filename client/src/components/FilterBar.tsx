...
export default function FilterBar({
  ...
  return (
    ...
    >
      <div
        className={`w-full lg:w-xl h-full transition-all ease-in-out 
      ...
      >
        ...
        >
          <button
            className={`bg-sky-600 w-full h-full lg:h-40 
        ...
        >
          {/* TITLE */}
          <h2 className="text-2xl text-sky-600 font-bold">ADJUST FILTERS</h2>
          ...
          <div className="flex justify-center items-center w-full space-x-4 mt-8">
            {/* RESET FILTER */}
            <button
              className="bg-slate-500 rounded-md px-8 py-2 text-white font-bold cursor-pointer"
