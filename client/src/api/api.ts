...
export const getUsers = async (filter: Filter): Promise<Response<User[]>> => {
  try {
    ...
    return {
      errorMsg: "Unable to process users, please try again later",
      data: [],
    };
  }
};
...
export const getTotalUserCount = async (
  ...
  try {
    ...
    return {
      errorMsg: "Unable to get user count, please try again later",
      data: 0,
    };
  }
};
  ...
  try {
    ...
    return {
      errorMsg:
        ...
        "Unable to add user, please make sure email is unique",
      data: [],
    };
  }
};
